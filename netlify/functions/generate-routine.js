    ...
    const messages = [
      {
        role: "system",
        content:
          "You are a professional beauty and skincare expert. Create personalized beauty routines based on the products provided. Format your response using bullet points (•) and numbered lists (1., 2., 3.) instead of markdown symbols like # or *. Use clear, simple formatting that's easy to read in a web browser.",
      },
      {
        role: "user",
        content: `Please create a personalized beauty routine using these products: ${JSON.stringify(
          productData,
          null,
          2
        )}. 
